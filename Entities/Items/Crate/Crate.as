...
void onInit(CBlob@ this)
{
	...
	if (this.exists("frame"))
	{
		...
		const string packed = this.get_string("packed");
...
bool canUnpackHere(CBlob@ this)
{
	...
	const bool water = packed == "longboat" || packed == "warboat";
	if (this.isAttached())
	{
	...
	const bool inwater = map.isInWater(this.getPosition() + Vec2f(0.0f, 8.0f));
