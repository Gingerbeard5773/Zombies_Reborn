// scroll script that converts iron blocks into gold blocks
...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	...
	caller.CreateGenericButton(11, Vec2f_zero, this, this.getCommandID("server_execute_spell"), desc(Translate::ScrollGilding));
}
