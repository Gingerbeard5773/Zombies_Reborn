//MAY 4, 2024
//THIS FILE WAS ADDED TO PATCH A BASE-KAG BUG. PLEASE REMOVE THIS FILE WHEN THE BASE KAG FILE IS FIXED.
//THE PARTICULAR FIX FOR THIS MOD IS AT LINE 118, WHERE AS BASE KAG IS MISSING THIS LINE.
		        ...
		        item.timeCreated + item.ticksToMake < time)
		{
			...
			if (getNet().isServer())
			{
				...
				if (blob !is null)
				{
					...
					// track it
					this.push(PRODUCTION_TRACKING_ARRAY, blob.getNetworkID());
					CBitStream params;
