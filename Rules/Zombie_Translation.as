...
namespace Translate
{
	...
	//gamehelp
	ZF   = Translate("ZOMBIE FORTRESS",                                                     "ЗОМБИ КРЕПОСТИ"),
	Tips = Translate("TIPS",                                                                "Напутствие"),
	...
	Tip3 = Translate("Use water to temporarily stop a burning wraith.",                     "Используйте воду, чтобы потушить горящего духа."),
	...
	PrecisionDrills = Translate("Precision Drilling\nDrills yield 100%.",                            "Мастерское Сверление\nПроизводительность сверла достигает своего пика 100%."),
	...
	MachineBows     = Translate("Machine Bows\nMounted Bows fire faster.",                           "Механизированные Луки\Установки стреляют быстрее."),
