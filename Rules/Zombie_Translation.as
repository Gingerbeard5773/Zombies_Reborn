...
namespace Translate
{
	...
	Stat2 = Translate("Most kills: {INPUT}",             "Совершил больше всего убийств: {INPUT}"),
	Stat3 = Translate("Most deaths: {INPUT}",            "Умирал чаще всего: {INPUT}"),
