...
namespace Translate
{
	...
	TaskPath               = Translate("Go to",               "Переместиться в"),
	TaskDorm               = Translate("Go to dormitory",     "Перейдите в общежитие"),
	TaskFactory            = Translate("Handle factory",      ""),
	TaskLibrary            = Translate("Research at library", ""),
	TaskTurret             = Translate("Handle turret",       "Управление турелью"),
	TaskBoat               = Translate("Row boat",            "Гребите на лодке"),
	TaskFollow             = Translate("Follow",              "Следовать"),
	TaskTree               = Translate("Chop trees",          "Рубить деревья"),
	TaskGrain              = Translate("Harvest grain",       "Сбор зерна"),
	TaskGather             = Translate("Gather",              "Собирать"),
	TaskDeposit            = Translate("Deposit inventory",   "Депозитный запас"),
	TaskFuel               = Translate("Fuel building",       "Залейте топливо"),
	TaskSafety             = Translate("Go to safety",        "Отправляйтесь в безопасное место"),
	TaskPatrol             = Translate("Patrol",              "Патруль"),
	TaskGuard              = Translate("Guard",               "Сторожить"),
	TaskRefill             = Translate("Refill ammunition",   "Пополнить боеприпасы"),
	...
	GuideVogue4            = Translate("Theres a guy named Bobert that might show up soon.",                                         ""),
	GuideVogue5            = Translate("Bobert is here! He may be undead and a little crazy but hes got the good stuff.",            ""),
	...
	GuideVogue8            = Translate("Tim the enchanter is here, if you pay him he will enchant your items! What a cool wizard!",  ""),
	...
	GuideItem13            = Translate("That Bazooka you have there is quite a spectacle of technology. It uses big bombs as ammo!",                       ""),
	GuideItem14            = Translate("Is that a flamethower you got? It siphons molotovs for a continuous stream of flame.",                             ""),
	...
	Flamethrower           = Translate("Flamethrower\nHOT HOT! uses molotovsa.",                   ""),
	Bobert0                = Translate("I'll be takinge my leave soonm,,..",                       "Я скора уййду..."),
	Bobert1                = Translate("Goodbye.",                                                 "Прощай."),
	Bobert2                = Translate("Be carefule withe that!!.",                                "Буть с этим остарожен."),
	Bobert3                = Translate("Lotsa of valuables! for sale!",                            "Множества ценых вищей на продажу!"),
	Bobert4                = Translate("Hi!!! Buy my stuff! :D",                                   "Привет! Купи мои вещи!"),

	//enchanter
	Enchanter0             = Translate("Bring forth the items I seek and you shall be rewarded.", ""),
	Enchanter1             = Translate("Excellent. Bring forth an item you wish to be given power.", ""),
	Enchanter2             = Translate("I cannot bestow this item with magic.", ""),
	Enchanter3             = Translate("This object has no arcane potential.", ""),
	Enchanter4             = Translate("This is an unenchantable item.", ""),
	Enchanter5             = Translate("I return whence I came. Goodbye.", ""),
	Enchanter6             = Translate("You have paid, but I must leave now. I shall enchant randomly.", ""),
	Enchanter7             = Translate("I have used enough of my magic, I am leaving. Farewell.", ""),
	Enchanter8             = Translate("For my services, you must deliver the items I ask for.", ""),
	Enchanter9             = Translate("Provide me with what I require.", ""),
	Enchanter10            = Translate("Very well. Place before me what you seek to strengthen.", ""),
	Enchanter11            = Translate("To have the gall to attempt such a thing, shame on thee...", ""),

	EnchantGUI0            = Translate("Give Payment", ""),
	EnchantGUI1            = Translate("Assess Item", ""),
	EnchantGUI2            = Translate("Tim requires these items as remittance", ""),
	EnchantGUI3            = Translate("Do you wish to enchant this item?", ""),
	EnchantGUI4            = Translate("Enchants into $BLUE$ {ITEM}", ""),
	EnchantGUI5            = Translate("{INPUT} Enchants left", ""),

	Wings                  = Translate("Dragoon Wings\nMythical wings forged from magic.", ""),
	GoldenHelmet           = Translate("Golden Helmet\nAn enchanted helmet etched with rune magic.", ""),
	GoldenArmor            = Translate("Golden Armor\nAn enchanted breastplate etched with rune magic.", ""),
	GoldenChicken          = Translate("Golden Chicken\nA legendary chicken from myths which lays golden eggs.", ""),
	...
	StatEnchants           = Translate("Items Enchanted",            ""),
	StatBombs              = Translate("Bombs Used",                 ""),
	StatWaterBombs         = Translate("Water Bombs Used",           ""),
	StatKegs               = Translate("Kegs Used",                  ""),
	StatMolotovs           = Translate("Molotovs Used",              ""),
	...
	Civilization           = Translate("Civilization\nHarbor 15 workers all at once",                                            ""),
	PokeyPokey             = Translate("Pokey Pokey\nPlace 500 spikes in one game",                                              ""),
	DragoonWarrior         = Translate("Dragoon Warrior\nWear the legendary dragoon set",                                        ""),
	Imbued                 = Translate("Imbued\nSuccessfully enchant an item with Tim",                                          ""),
	TheSacrifice           = Translate("The Sacrifice\nYou were taken by Tim!",                                                  ""),
