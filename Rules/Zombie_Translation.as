...
void SetupTranslations()
{
	...
	d.set("GuideRelevant1",         Init("Have you built a library yet? Upgrades are important.",                                      ""));
	d.set("GuideRelevant2",         Init("Put some scholars in the library, they will speed up technological research.",               ""));
	d.set("GuideRelevant3",         Init("The necromancer! You can tell what spell hes conjuring from the color of his orbs!",         ""));
	d.set("GuideRelevant4",         Init("Theres a guy named Bobert that might show up soon.",                                         ""));
	d.set("GuideRelevant5",         Init("Bobert is here! He may be undead and a little crazy but hes got the good stuff.",            ""));
	d.set("GuideRelevant6",         Init("If you get too close to that portal it will activate and all hell will break loose.",        ""));
	d.set("GuideRelevant7",         Init("If you damage the portal and fail to destroy it, things will only get worse, do your best!", ""));
	d.set("GuideRelevant8",         Init("Tim the enchanter is here, if you pay him he will enchant your items! What a cool wizard!",  ""));

	d.set("GuideScrollRoyalty",     Init("Yeah thats a scroll.",                                                                                             ""));
	d.set("GuideScrollClone",       Init("Ah yes, the mythical scroll of duplication. It's capable of cloning something perfectly, with all its contents!",  ""));
	d.set("GuideScrollSea",         Init("The sea scroll has been hated by many villagers in the past for flooding their towns..",                           ""));
	d.set("GuideScrollCrate",       Init("The crate scroll that you have is very powerful. It is even capable of sealing devils within boxes, as they say.", ""));
	d.set("GuideScrollRevive",      Init("Hmm, the scroll of revival. A strong spell that can bring many friends back if used properly.",                    ""));
	d.set("GuideScrollHealth",      Init("The scroll of health is best used when around all your friends, as it will bless everyone nearby!",                ""));
	d.set("GuideScrollCarnage",     Init("That is quite the scroll you are carrying. I suggest using it only when in serious peril.",                        ""));
	d.set("GuideScrollTeleport",    Init("The scroll of conveyence. Quite handy for getting out of dangerous situations.",                                   ""));
	d.set("GuideScrollRepair",      Init("The scroll of repair is best reserved for your most expensive walls and traps.",                                   ""));
	d.set("GuideScrollMidas",       Init("That midas scroll is of great value. Use it around a large patch of stone for maximum benefit.",                   ""));
	d.set("GuideScrollStone",       Init("The scroll of quarry converts dirt to stone, and stone to iron.",                                                  ""));
	d.set("GuideScrollDesiccation", Init("The scroll of desiccation is a powerful scroll capable of vaporizing all the water you can ever see.",             ""));
	d.set("GuideScrollResurgence",  Init("Oh my, what a powerful scroll this is! It will resurrect everyone!",                                               ""));
	d.set("GuideScrollTime",        Init("That scroll appears to be enchanted with magic that speeds up the flow of time, how interesting.",                 ""));
	d.set("GuideScrollObliteration",Init("With such a powerful scroll of that caliber, you could annihilate entire armies!",                                 ""));
	d.set("GuideScrollIron",        Init("The scroll of iron will convert all the surrounding stone blocks into iron blocks.",                               ""));
	d.set("GuideScrollGilding",     Init("The scroll of gilding will plate all the surrounding iron blocks in enchanted gold.",                              ""));
	d.set("GuideScrollRewind",      Init("This appears to be forbidden magic. Perhaps such a scroll should be used when you have made major mistakes.",      ""));
	d.set("GuideHolyGrenade",       Init("Is that the famed Holy Hand Grenade of Antioch? Be careful with that now, we don't want to have an accident.",     ""));
	d.set("GuideShotgun",           Init("Ah the shotgun, foreign technology brought in by Tim. Yours seems to hold two shots.",                             ""));
	d.set("GuideBazooka",           Init("That Bazooka you have there is quite a spectacle of technology. It uses big bombs as ammo!",                       ""));
	d.set("GuideFlamethrower",      Init("Is that a flamethower you got? It siphons molotovs for a continuous stream of flame.",                             ""));
	d.set("GuideMagicQuiver",       Init("The enchanted quiver conjures arrows so often, you may never need to retreat from battle as an archer.",           ""));
	d.set("GuideTrident",           Init("Ah, a magic trident. It will always return to its master when thrown.",                                            ""));
	d.set("GuideGoldenHelmet",      Init("A golden helmet? Perhaps it will grant you great durability when paired with golden armor!",                       ""));
	d.set("GuideGoldenArmor",       Init("Golden armor? Perhaps it will grant you great durability when paired with a golden helmet!",                       ""));
	d.set("GuideCrownTelepathy",    Init("I never thought i'd see the magical crown of telepathy. It lets you sense enemies even in the dark.",              ""));
	d.set("GuideWings",             Init("Legends tell of dragoon warriors with armor of gold and wings just like yours..",                                  ""));
	d.set("GuideGoldenChicken",     Init("What a special chicken you have there. Perhaps it lays golden eggs just like in fairy tales.",                     ""));
	...
	d.set("CrownTelepathy",         Init("Crown Of Telepathy\nA crown bestowed with mysterious runes.",            ""));
