...
namespace Translate
{
	...
	SetRecipe      = Translate("Set Recipe",                     ""),
	CurrentRecipe  = Translate("Current Recipe",                 ""),
	...
	LightBallista  = Translate("A portable ballista. Can be attached to some vehicles.",                              ""),
	Cannon         = Translate("A cannon that is capable of obliterating any foe. Can be attached to some vehicles.", ""),
	Zeppelin       = Translate("A sky fortress with many accomodations on board. Functions as a respawn point.",      ""),
	...
	HeadLamp       = Translate("Head Lamp\nWearable lantern for easy illumination!"                                     ""),
	...
	GreekFire       = Translate("Greek Fire\nIncendiary weapons deal +50% damage.",                  ""),
	...
	TorsionWinch    = Translate("Torsion Winch\nSeige vehicles fire projectiles 35% farther.",       ""),
	SeigeCrank      = Translate("Seige Crank\nSeige vehicles fire 25% faster",                       ""),
